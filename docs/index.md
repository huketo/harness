...
| --- | --- |
| [Installation](guides/installation.md) | Linux/WSL2 prerequisites, installer side effects, configuration opt-in, retired-link cleanup, updates, and manual rollback. |
| [상세 사용법](guides/usage.md) | Built-in session pinning, profiles, session/shared effort, built-in compaction, Herdr execution, BrowserSkill on WSL2, and interface improvement/review. |
