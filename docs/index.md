...
| [상세 사용법](guides/usage.md) | Built-in session pinning, profiles, session/shared effort, built-in compaction, Herdr execution, Windows Chrome, and interface improvement/review. |
